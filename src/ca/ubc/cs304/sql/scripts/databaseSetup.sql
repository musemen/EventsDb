...
INSERT INTO Event (EventId,VenueId,OrganizationID,Name,StartTime,EndTime,Url) VALUES("1","1","1","Vancouver Canucks vs. Pittsburgh Penguins",CONVERT(date, '2019-12-22'),CONVERT(date, '2019-13-22'),"https://www.ticketmaster.ca/vancouver-canucks-vs-pittsburgh-penguins-vancouver-british-columbia-12-21-2019/event/11005724CCF73B0D");
INSERT INTO Event (EventId,VenueId,OrganizationID,Name,StartTime,EndTime,Url) VALUES("2","2","2","Buy One Get One Free Icecream - Rain Or Shine",CONVERT(date, '2020-03-22'),CONVERT(date, '2020-03-31'), "http://rainorshineicecream.com/events/");
INSERT INTO Event (EventId,VenueId,OrganizationID,Name,StartTime,EndTime,Url) VALUES("4","2","2","Free Icecream - Rain Or Shine",CONVERT(date, '2020-05-01'),CONVERT(date, '2020-05-08'), "http://rainorshineicecream.com/events/");
INSERT INTO Event (EventId,VenueId,OrganizationID,Name,StartTime,EndTime,Url) VALUES("3","3","3","$5 Bubble Tea Promo - Limtied Time Offer",CONVERT(date, '2020-02-25'),CONVERT(date, '2020-03-25'), "https://www.yelp.ca/biz/dragon-ball-tea-house-vancouver");
INSERT INTO Event (EventId,VenueId,OrganizationID,Name,StartTime,EndTime,Url) VALUES("5","4","4","Soft Opening - First 100 People 50% Off",CONVERT(date, '2020-06-22'),CONVERT(date, '2020-06-22'),"https://thepokeguy.ca/");
INSERT INTO Event (EventId,VenueId,OrganizationID,Name,StartTime,EndTime,Url) VALUES("6","1","5","Martin Garrix World Tour",CONVERT(date, '2020-08-22'),CONVERT(date, '2020-08-24'), "https://martingarrix.com/");
INSERT INTO Event (EventId,VenueId,OrganizationID,Name,StartTime,EndTime,Url) VALUES("7","1","6","Vancouver WhiteCaps Exhibition Match", CONVERT(date, '2020-04-10'),CONVERT(date, '2020-0-22'), "https://whitecaps.ca"/);
INSERT INTO Event (EventId,VenueId,OrganizationID,Name,StartTime,EndTime,Url) VALUES("8","5","7","Poits After Party",CONVERT(date, '2020-06-22'),CONVERT(date, '2019-06-22'),"https://celebritiesnightclub.com/");
INSERT INTO Event (EventId,VenueId,OrganizationID,Name,StartTime,EndTime,Url) VALUES("9","6","8","Powell Street Festival",CONVERT(date, '2020-06-22'),CONVERT(date, '2019-06-22'),"http://www.powellstreetfestival.com/");
INSERT INTO Event (EventId,VenueId,OrganizationID,Name,StartTime,EndTime,Url) VALUES("10","7","9","Columbia StrEAT Food Truck Fest",CONVERT(date, '2020-07-14'),CONVERT(date, '2019-08-17'),"https://downtownnewwest.ca/");
INSERT INTO Event (EventId,VenueId,OrganizationID,Name,StartTime,EndTime,Url) VALUES("11","8","11","The Fair At the PNE",CONVERT(date, '2020-08-01'),CONVERT(date, '2020-09-02'),"https://www.pne.ca/");
